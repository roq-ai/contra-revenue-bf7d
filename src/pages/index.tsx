...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`contra revenue`}</title>

        <meta
          name="description"
          content="Welcome to Contra Revenue - Your ultimate search tool and knowledge base for addressing transaction reporting queries, requests, and issues. Poised for continual enhancement, including future chatbot development."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1461938337379-4b537cd2db74?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzZWFyY2glMjB0b29sfGVufDB8fHx8MTY5NDU5ODkyNHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@dsiglin?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`David Siglin`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Contra Revenue - Your ultimate search tool and knowledge base for addressing transaction reporting queries, requests, and issues. Poised for continual enhancement, including future chatbot development.`}
            </Text>
            <Box
