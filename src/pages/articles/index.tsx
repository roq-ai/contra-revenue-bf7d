...
export function ArticleListPage(props: ArticleListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getArticles({
        relations: ['organization', 'article_keyword.count', 'history.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('article_keyword', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('history', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'history',
          header: 'History',
          accessorKey: 'history',
          cell: ({ row: { original: record } }: any) => record?._count?.history,
        }
      : null,
