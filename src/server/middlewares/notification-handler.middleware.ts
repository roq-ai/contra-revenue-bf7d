...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'article.update': {
    roles: ['system-administrator', 'knowledge-manager'],
    key: 'knowledge-manager-article-update',
    tenantPath: ['organization', 'article'],
    userPath: [],
  },
  'article.create': {
    roles: ['system-administrator', 'knowledge-manager'],
    key: 'knowledge-manager-article-create',
    tenantPath: ['organization', 'article'],
    userPath: [],
  },
  'article.delete': {
    roles: ['system-administrator', 'knowledge-manager'],
    key: 'knowledge-manager-article-delete',
    tenantPath: ['organization', 'article'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['system-administrator', 'knowledge-manager'];
