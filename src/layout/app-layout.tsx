...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['system-administrator', 'knowledge-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Histories', path: '/histories', entity: 'history', service: AccessServiceEnum.PROJECT, icon: FiClock },
    { name: 'Keywords', path: '/keywords', entity: 'keyword', service: AccessServiceEnum.PROJECT, icon: FiKey },
